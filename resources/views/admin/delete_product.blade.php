		...
		<div class="row">
			...
			<div class="col-10 ad_conntent">
				...
				<div align="center">
					...
					@else
					<h3>Xác nhận xoá sản phẩm: {{ $row->name }}</h3>


					<form method="post" action="{{ url('deleteProduct') }}" enctype="multipart/form-data">
						{{csrf_field()}}
						...
						<a type="button" class="btn btn-secondary" href="{{ url('admin') }}">Không</a>
					</form>
					@endif
